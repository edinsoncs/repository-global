...
# 3. Extract structured info from text via HuggingFaceLLM
...
class HuggingFaceLLM:
    ...
    def generate(self, prompt, max_length=1024):
        ...
        text = self.tokenizer.decode(predictions[0], skip_special_tokens=True)
        return text
...
def main():
    default_data_points = """{
        ...
        "education": [{
            ...
            "institution": "institution where degree was obtained",
            "year": "year degree was obtained"
        }]
    }"""
